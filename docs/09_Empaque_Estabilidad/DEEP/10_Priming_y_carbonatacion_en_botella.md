...
## Navegación rápida
- Entrada desde 07 (antes de envasar): [07/30 — Transferencias y salida](../../07_Fermentacion_Maduracion/DEEP/30_Transferencias_cold_crash_y_salida.md)
- Preparación para envasar: [05 — Preparación para envasar](05_Preparacion_para_envasar.md)
- Oxígeno (purga/llenado): [20 — Control de oxígeno (DO/TPO)](20_Control_oxigeno_DO_TPO.md)
- Almacenamiento: [30 — Luz/temperatura/almacenamiento](30_Luz_temperatura_almacenamiento.md)
- Fallas y diagnóstico: [40 — Shelf-life y troubleshooting](40_Shelflife_y_troubleshooting_empaque.md)
- Registro por lote: [TP — Log de envasado y estabilidad](TP_Log_Envasado_y_Estabilidad.md)

---

## 1) Gate previo “listo para embotellar” (obligatorio)
...
## 3) Elegir el objetivo de CO₂ (regla por estilo)
Guía simple (rangos):
- Ales “normales” (APA/Amber/Porter): 2.1–2.5 vol
- Lagers: 2.3–2.7 vol
- Stout / estilos más “cremosos”: 1.8–2.3 vol
- Wheat / Belgian más gasificadas: 2.7–3.4 vol

> Si no querés complicarte: elegí 2.4 vol como estándar general y ajustamos con tus notas de cata.

---

## 4) Cálculo de priming (paso a paso, sin magia)
Necesitás 3 datos:
1) **Litros reales** a embotellar
2) **Temperatura de la cerveza al embotellar** (idealmente la *más alta* que tuvo en los últimos días, porque a mayor temperatura queda menos CO₂ residual)
3) **Objetivo de CO₂** (volúmenes)

### 4.1 CO₂ residual aproximado según temperatura
(para no perder tiempo; valores típicos)
- 10°C → ~1.2 vol
- 15°C → ~1.0 vol
- 20°C → ~0.85 vol
- 25°C → ~0.75 vol

### 4.2 Fórmula simple (suficiente para operar)
1) Calculá: **CO₂ a agregar = objetivo − residual**
2) Elegí azúcar:

- **Dextrosa (glucosa / “azúcar de maíz”)**:  
  `gramos = litros × CO₂_a_agregar × 4.0`

- **Sacarosa (azúcar común)**:  
  `gramos = litros × CO₂_a_agregar × 3.8`

- **DME (extracto seco)** (menos exacto):  
  `gramos = litros × CO₂_a_agregar × 5.5` (aprox.)

### 4.3 Ejemplo rápido
- Volumen: 19 L  
- Temp: 20°C → residual 0.85 vol  
- Objetivo: 2.4 vol  
- A agregar: 2.4 − 0.85 = 1.55 vol  
- Dextrosa: 19 × 1.55 × 4.0 = **~118 g**

---

## 5) Método de trabajo (para que salga siempre igual)
### 5.1 Preparar el “jarabe” de priming
1) Pesar el azúcar.
2) Disolver en poca agua, hervir 5 minutos.
3) Enfriar tapado.

### 5.2 Mezclar sin meter aire
- Poner el jarabe en el balde/recipiente de embotellado.
...
## 7) Fallas típicas (diagnóstico rápido)
### 7.1 Falta de carbonatación
Causas frecuentes:
- temperatura de acondicionamiento baja o variable,
- poco tiempo,
- levadura débil,
...
Anotar por lote:
- temperatura de cerveza al embotellar,
- azúcar usada (tipo + gramos),
- litros reales,
...
## Puentes (no duplicar)
- Oxígeno/DO/TPO: [20 — Control de oxígeno](20_Control_oxigeno_DO_TPO.md)
- Almacenamiento: [30 — Luz/temperatura/almacenamiento](30_Luz_temperatura_almacenamiento.md)
